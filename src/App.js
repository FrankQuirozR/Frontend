    ...
    <Popup className="custom-popup">
      <div className="w-72 p-4 rounded-lg shadow-lg bg-white">
        ...
        <div className="space-y-4">
          <div
            className={`flex items-center justify-between mb-2 ${airQuality.bgColor} rounded-lg p-3`}
          >
            <div className="flex items-center space-x-1">
              <div style={containerStyle}>
                <img src={pmGif} alt="PM2.5" style={imageStyle} />
              </div>
              <span className="font-medium mr-2">PM2.5</span>
            </div>
            <div className="text-right">
              <span className={`${airQuality.color} font-bold`}>
                {pm25Value} µg/m³
              </span>
          ...
          <div className="flex items-center justify-between bg-blue-50 rounded-lg p-3">
            <div className="flex items-center space-x-1">
              ...
              <span className="font-medium" style={{ minWidth: "100px" }}>
                Temperatura
              </span>
            </div>
          ...
          <div className="flex items-center justify-between bg-teal-50 rounded-lg p-3">
            <div className="flex items-center">
              <div style={containerStyle}>
                <img src={humedadGif} alt="Humedad" style={imageStyle} />
              </div>
              <span className="font-medium mr-2">Humedad</span>{" "}
...
const App = () => {
  ...
  const fetchDistrictName = async (latitude, longitude) => {
    try {
      ...
      console.error(
        "No se encontraron resultados en la respuesta de Nominatim"
      );
      return "Desconocido";
    } catch (error) {
  ...
  console.log("AQUI DATA", stations)
  ...
  useEffect(() => {
    const fetchDistricts = async () => {
      ...
      for (const station of stations) {
        ...
        const longitude =
          station["decimalLongitude "] || station.decimalLongitude;
          ...
          <div className="sidebar">
            <StationSidebar
              ...
              measurements={getLatestMeasurements(
                selectedStation.station.measurements
              )}
              onClose={handleCloseSidebar}
            />
            <div>
              <GraficosEstacion
                measurements={selectedStation.station.measurements}
              />
            </div>
          </div>
        )}
